		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ön Sipariş",
									"targetURL": "#comimprovazimpsaosipapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comimprovazimpsaosipapp-display": {
								"semanticObject": "comimprovazimpsaosipapp",
								"action": "display",
								"description": "Satış Ön sipariş Uygulaması",
								"title": "Ön Sipariş",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.improva.zimpsaosipapp",
									"url": sap.ui.require.toUrl("com/improva/zimpsaosipapp")
								}
							}
						}
					}
